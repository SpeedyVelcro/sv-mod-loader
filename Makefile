...
clean: clean-example-mod-blue-player clean-example-mod-blue-player clean-example-mod-red-background
...
install-example-mods: install-example-mod-blue-player install-example-mod-yellow-player install-example-mod-red-background
...
uninstall-example-mods: uninstall-example-mod-blue-player uninstall-example-mod-yellow-player uninstall-example-mod-red-background
